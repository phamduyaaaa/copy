...
local_costmap:
  local_costmap:
    ros__parameters:  
      ...
      # [QUAN TRỌNG] Đã thêm obstacle_layer để robot nhìn thấy tường từ Lidar
      ...
      # Cấu hình Lidar 2D (Bắt buộc phải có để tránh tường)
      obstacle_layer:
      ...
      rgbd_obstacle_layer:
        ...
        rgbd1_mark:
          ...
          topic: /camera/realsense_camera/depth/color/points # Topic chuẩn của RealSense
          reliability: best_effort  # Bắt buộc cho RealSense
          marking: true
          clearing: false
          obstacle_range: 3.0
      ...
      # Giữ lại Range Layer nếu bạn dùng sonar
      range_layer:
...
global_costmap:
  global_costmap:
    ros__parameters:
      ...
      # Thêm STVL vào Global Costmap (để tránh vật cản cố định như bàn ghế)
      rgbd_obstacle_layer:
        plugin: "spatio_temporal_voxel_layer/SpatioTemporalVoxelLayer"
        enabled:                  true
        voxel_decay:              -1    # -1: Nhớ mãi mãi (cho global map)
        decay_model:              0
        voxel_size:               0.05
        track_unknown_space:      true
        mark_threshold:           0
        ...
        publish_voxel_map:        true
        transform_tolerance:      0.2
        mapping_mode:             true  # Mapping mode bật cho global
        map_save_duration:        60.0
