...
controller_server:
  ros__parameters:
    ...
    FollowPath:
      ...
      ConstraintCritic: {enabled: true, cost_weight: 4.0}
      CostCritic: {enabled: true, cost_weight: 3.81, critical_cost: 300.0, consider_footprint: true, collision_cost: 1000000.0}
      GoalCritic: {enabled: true, cost_weight: 5.0}
      PathAlignCritic: {enabled: true, cost_weight: 14.0}
      PathFollowCritic: {enabled: true, cost_weight: 5.0}
      PathAngleCritic: {enabled: true, cost_weight: 2.0}
      PreferForwardCritic: {enabled: true, cost_weight: 5.0}
  ...
  global_costmap:
    ros__parameters:
      ...
      obstacle_layer:
        ...
        scan: {topic: /scan_filter, data_type: "LaserScan", clearing: true, marking: true}
      inflation_layer: {plugin: "nav2_costmap_2d::InflationLayer", cost_scaling_factor: 5.0, inflation_radius: 0.5}
...
collision_monitor:
  ros__parameters:
    ...
    observation_sources: ["scan"]
    scan: {type: "scan", topic: "scan_filter"}
...
docking_server:
  ros__parameters:
    ...
    docks: ['home_dock']
    home_dock: {type: 'simple_charging_dock', frame: map, pose: [0.0, 0.0, 0.0]}
```
